...
| 2026-08-14 | Ripple | Treasury Manager, Global Treasury Ops (NY) | 8 | **DRAFTED — decision surface ready**; New York posting verified 2026-08-14, NY annual base salary range $144K–$180K; packet/brief/form-prep note now ready for Josh’s hold/tweak/kill verdict | Josh | `jobs/packets/active/ripple-treasury-manager-global-treasury-ops/packet.md` + `decision-brief.md` + `form-prep-note.md` | [Ripple careers](https://ripple.com/careers/all-jobs/job/7767531?gh_jid=7767531) |
