...
| 2026-09-08 | Anchorage Digital | Trading Operations Team Lead (remote US) | 9 | **DRAFTED — primary decision surface**; official public Lever feed remains live and the packet/brief/source note/preflight bank/next-step note remain current from the 2026-09-05 source recheck after the 2026-09-08 morning re-entry. Exact match on post-trade settlement, reconciliation, controls, and client coordination; compensation is still not publicly disclosed, so it must clear the remote floor before an application discussion. | Josh | `jobs/packets/active/anchorage-trading-operations-team-lead/packet.md` + `decision-brief.md` + `source-recheck-note.md` + `application-form-preflight.md` + `next-step-note.md` | [official Lever posting](https://jobs.lever.co/anchorage/b3c332bc-ffc5-4a2f-ab3e-de136d326408) |
