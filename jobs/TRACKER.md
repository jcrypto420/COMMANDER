...
|| 2026-08-11 | Coinbase | Business Operations Senior Associate, Institutional | 8 | **PARKED — WEEKLY HEDGE ONLY**; re-verified after morning repo sync/rebase/pull recovery; official Greenhouse feed confirms Remote — USA, job `7980600` | Josh | `jobs/packets/active/coinbase-institutional-business-ops/packet.md` + `decision-brief.md` | [official ATS](https://www.coinbase.com/careers/positions/7980600?gh_jid=7980600) |
