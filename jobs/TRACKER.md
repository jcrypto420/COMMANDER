...
|| 2026-09-22 | Anchorage Digital | Trading Operations, Transformation Lead (remote US) | 9 | **DRAFTED — primary decision surface**; official public Lever page rechecked 2026-09-22 still shows the role as open (posting ID `b3c332bc`), Remote — United States, Global Operations → Trading Operations, but the live title has changed from "Trading Operations Team Lead" to **"Trading Operations, Transformation Lead"** — same posting ID, same remote-US scope. Exact match on post-trade settlement, reconciliation, controls, and client coordination; the "Transformation Lead" framing is a positive fit signal over the prior "Team Lead" title. Compensation is still not publicly disclosed, so it must clear the remote floor before an application discussion. | Josh | `jobs/packets/active/anchorage-trading-operations-team-lead/packet.md` + `decision-brief.md` + `source-recheck-note.md` + `application-form-preflight.md` + `next-step-note.md` | [official Lever posting](https://jobs.lever.co/anchorage/b3c332bc-ffc5-4a2f-ab3e-de136d326408) |
|| 2026-09-23 | Anchorage Digital | Member of Trading Operations (remote US) | 8 | **DRAFTED — secondary fallback surface**; drafted ahead on 2026-09-23 per draft-ahead rule. Same remote-US scope and Global Operations → Trading Operations department as the primary candidate; individual-contributor framing that avoids the people-management stretch. Posting requires 3+ years institutional settlement across traditional AND crypto assets, plus rotational weekend/holiday coverage. Compensation not disclosed; same remote-floor gate applies. | Josh | `jobs/packets/active/anchorage-member-of-trading-operations/packet.md` + `decision-brief.md` + `source-recheck-note.md` | [official Lever posting](https://jobs.lever.co/anchorage/0f13c760-a28f-4750-8b6f-2b6d5e5b10cf) |
