...
| 2026-08-20 | Ripple | Treasury Manager, Global Treasury Ops (NY) | 8 | **DRAFTED — decision surface ready**; morning-sync refreshed 2026-08-20; New York posting verified 2026-08-14 and live-rechecked again 2026-08-20; NY annual base salary range $144K–$180K; packet/brief/form-prep note plus `source-recheck-note.md` now ready for Josh’s hold/tweak/kill verdict | Josh | `jobs/packets/active/ripple-treasury-manager-global-treasury-ops/packet.md` + `decision-brief.md` + `form-prep-note.md` + `source-recheck-note.md` | [Ripple careers](https://ripple.com/careers/all-jobs/job/7767531?gh_jid=7767531) |
