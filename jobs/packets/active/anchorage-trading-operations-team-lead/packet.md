...
**Morning sync:** 2026-09-05 re-entry — repo sync/rebase recovered cleanly after the overnight Pi reboot; the live no-login source surface is still open and draft-only, so the packet remains current without a new external source change.
