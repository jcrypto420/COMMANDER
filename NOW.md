...
3. **Cash runway:** review the Anchorage Digital Trading Operations Team Lead decision brief first: the official public Lever feed is still the live remote-US role; the draft packet, brief, and source note are ready on the 2026-08-28 morning sync. It is a precise settlement/reconciliation/control fit; its undisclosed compensation must clear the $120K remote floor (prefer $150K+) and the global-team-lead scope must be an acceptable player-coach stretch before any application discussion. Ripple is secondary hold only.
