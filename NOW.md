...
2. **CI-1 — Anchorage Digital Trading Operations, Transformation Lead:** the primary cash-runway decision surface. The official public Lever page was rechecked on 2026-09-22: posting ID `b3c332bc` is still open, Remote — United States, under Global Operations → Trading Operations, but the live title has changed from "Trading Operations Team Lead" to **"Trading Operations, Transformation Lead"** — same posting ID, same remote-US scope. The "Transformation Lead" framing is a positive fit signal vs. the prior title. The packet, decision brief, source note, application-form preflight, and next-step note are all updated to the new title and the 2026-09-22 recheck. Compensation is still not disclosed; the role stays gated on the remote floor ($120K min / $150K preferred) and Josh's scope verdict. Anchorage's board also lists a secondary live candidate — "Member of Trading Operations" (ID `0f13c760`) — flagged in the packet if this gate stays closed.
