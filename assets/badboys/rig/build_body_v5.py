...
# arms: shoulder -> elbow chevron out -> tip buried behind the pant-leg tops
ARM_R = HW * 0.030 * BS
shoulder_z = torso_top_z - HW * 0.02

sh_l = (BODY_CX - SHOULDER_W * 0.7, shoulder_z)
ctrl_l = (BODY_CX - SHOULDER_W - HW * 0.19, shoulder_z - TORSO_LEN * 0.52)
end_l = (torso_bot_cx - HIP_W * 0.45, waist_z - HW * 0.13)
arm_l_pts = tube_along(qbez(sh_l, ctrl_l, end_l), ARM_R)

sh_r = (BODY_CX + SHOULDER_W * 0.7, shoulder_z)
ctrl_r = (BODY_CX + SHOULDER_W + HW * 0.24, shoulder_z - TORSO_LEN * 0.50)
end_r = (torso_bot_cx + HIP_W * 0.45, waist_z - HW * 0.13)
...
scene.render.filepath = "/private/tmp/claude-501/-Users-joshstokesberry-COMMANDER/40483013-84ce-4f68-84e4-a1c6fbe36c8d/scratchpad/full_body_v5.png"
bpy.ops.render.render(write_still=True)
bpy.ops.wm.save_as_mainfile(filepath="/private/tmp/claude-501/-Users-joshstokesberry-COMMANDER/40483013-84ce-4f68-84e4-a1c6fbe36c8d/scratchpad/full_body_v5.blend")
print("DONE")
