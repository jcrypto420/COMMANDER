...
- **WO-2 cleanup pass (2026-08-19):** refreshed the repo-cleanup draft so the next pass is only a narrow stale-line sweep in the project docs and queue wording; the real proof remains the single local-only Pi capture run.
