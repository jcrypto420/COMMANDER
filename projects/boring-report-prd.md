...
- **Portfolio reset 2026-07-25:** The Boring Report is now the flagship compounding data/product build (see `projects/portfolio-reset-2026-07-25.md`). The next real artifact is **P2 Oracle Scorecard v0**: a small traceable protocol set with fact files, source snapshots, deterministic scoring, and a rendered internal review artifact. W28 remains a useful internal reference, but no longer blocks the build behind repeated Gate Deck nagging.
