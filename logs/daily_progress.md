...
- CC-24 draft-only update: tightened the live morning-report wording around the exact 5-line shape and synced the queue/project brief so tomorrow's run is pure verification.
