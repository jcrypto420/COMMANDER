...
## 2026-08-29 · draft-only, local handoff
...
The compare-only pilot remains the current literal-comparison surface. The WETH feed address and decimals stayed unchanged; the only observed movement in the verified comparison was in the latest-round fields.
