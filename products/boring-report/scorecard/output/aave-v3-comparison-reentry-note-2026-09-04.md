...
## 2026-09-04 · draft-only, local handoff
...
The compare-only pilot remains the current literal-comparison surface after the 2026-09-04 repo sync. The verified WETH comparison still says the feed address and decimals stayed unchanged; the only observed movement was in the latest-round fields.
