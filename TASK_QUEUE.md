...
| WO-2 | Weather Oracle | 1 | Compounding capture loop | todo | Draft-only: keep the 2026-08-11 handoff aligned and, on the Pi, run the single local-only capture proof next; then save the manifest/result note locally. | no |
