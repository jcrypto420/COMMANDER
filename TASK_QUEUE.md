...
| BB-26 | Bad Boys/Joycat | 1 | Hermes idea-bank + MoA critics cron | todo | 2026-07-12 approval packet now adds a one-glance decision surface plus exact local-only storage path; next safe step is Josh's ship/kill/tweak verdict on cadence + path | **yes** |
