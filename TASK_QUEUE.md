...
| CC-24 | Command Center | 1 | 5-line daily dispatch | todo | 2026-07-09 parser re-check passed; next safe step is tomorrow's 07:30 parser re-check — assert 5 lines, confirm `Open:` / `Decide:` stay on line 4, keep exactly one bolded `Decision:`, then archive if clean | verify only |
...
| BB-26 | Bad Boys/Joycat | 1 | Hermes idea-bank + MoA critics cron | todo | draft packet now includes a concrete 10-premise seed bank + cheap implementation shape; next safe step is Josh approval to verify the 10 premise prompts and approve the weekly cron surface | **yes** |
