...
|----|---------|-----|------|--------|-------------|----------|
| CI-1 | Career/Income | 1 | Daily job/application process | doing | OWED: `projects/ci-1-chainlink-packet.md` — complete send-ready application (tailored resume bullets from career-income.md, cover letter, posting answers). Artifact rule applies: no more slate metadata passes | **yes** to send |
| CI-1 | Career/Income | 1 | Daily job/application process | doing | OWED: `projects/ci-1-chainlink-packet.md` — complete send-ready application (tailored resume bullets from career-income.md, cover letter, posting answers). Artifact rule applies: no more slate metadata passes | **yes** to send |
