...
| CC-24 | Command Center | 1 | 5-line daily dispatch | todo | 2026-07-13 18:11 parser check passed again; next safe step is 2026-07-14 07:30 parser re-check — assert 5 lines, confirm `Open:` / `Decide:` stay on line 4, keep exactly one bolded `Decision:`, then archive if clean | verify only |
