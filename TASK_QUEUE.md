...
|| BB-26 | Bad Boys/Joycat | 1 | Hermes idea-bank + MoA critics cron | todo | 2026-07-14 draft packet now includes a one-run local smoke test with fallback model order and file-shape checks; next safe step is Josh's ship/kill/tweak verdict on cadence + storage path | **yes** |
