...
| BR-0 | Boring Report | 1 | Execute PRD Milestone P0 (data-source probe) | done→archive | P0 source probe completed and committed; `products/boring-report/` now also carries the P1 generator + verifier tooling and weekly issue v0 | no |
