...
| WO-2 | Weather Oracle | 2 | Compounding capture loop | blocked | Draft-only cleanup note created at `projects/weather-oracle-repo-cleanup-draft.md`; keep the packet / run sheet / result-note wording aligned and reopen only after the Boring Report proves paid demand or when a buyer/partner wedge makes Forecast Receipts commercially concrete. | no |
