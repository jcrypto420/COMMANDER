...
| CC-24 | Command Center | 1 | 5-line daily dispatch | todo | 2026-07-12 parser fix applied and the strict CC-24 check passed again; next safe step is tomorrow's 07:30 parser re-check — assert 5 lines, confirm `Open:` / `Decide:` stay on line 4, keep exactly one bolded `Decision:`, then archive if clean | verify only |
