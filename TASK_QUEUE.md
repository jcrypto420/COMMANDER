...
| WO-2 | Weather Oracle | 1 | Compounding capture loop | todo | Draft-only: the public gate stayed live after today’s 200/200 recheck; next step is the single local-only Pi capture proof, then save the manifest/result note locally. | no |
