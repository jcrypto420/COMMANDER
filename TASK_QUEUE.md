...
| WO-2 | Weather Oracle | 1 | Compounding capture loop | todo | Draft-only: keep the 2026-08-11 result-note handoff current; the next real step stays the single local-only Pi capture proof, then save the manifest/result note locally. | no |
