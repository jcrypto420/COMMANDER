...
| BB-25 | Bad Boys/Joycat | 1 | CARTOON LAB pilot | doing | Josh: script-gate verdict on 3 pilot cards in `projects/badboys-cartoon-lab.md` → Claude rigs the canonical puppet (Blender) + takes first approved script through all 7 stages | gates in doc |
