...
|----|---------|-----|------|--------|-------------|----------|
| CI-1 | Career/Income | 1 | Daily job/application process | doing | **PACKET DELIVERED** — `projects/ci-1-chainlink-packet.md` is send-ready; Josh verdict in the 8–9am window (or sooner). Next after verdict: Coinbase Billing Ops packet | **yes** to send |
| CI-1 | Career/Income | 1 | Daily job/application process | doing | **PACKET DELIVERED** — `projects/ci-1-chainlink-packet.md` is send-ready; Josh verdict in the 8–9am window (or sooner). Next after verdict: Coinbase Billing Ops packet | **yes** to send |
