...
| CI-1 | Career/Income | 1 | Global high-compensation cash runway | todo | Anchorage Digital Trading Operations Team Lead is the primary decision packet: live remote-US source remains current on the 2026-08-29 morning sync; packet/brief/source note plus the refreshed application-form preflight answer bank are ready. Confirm remote compensation clears $120K (prefer $150K+) and that player-coach leadership scope is acceptable before final tailoring; Ripple is secondary hold only. | **yes** to submit/send |
