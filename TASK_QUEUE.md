...
| CI-1 | Career/Income | 1 | Global high-compensation cash runway | todo | Anchorage Digital **Trading Operations, Transformation Lead** (posting ID `b3c332bc`) is the primary decision packet: the official public Lever page was rechecked on 2026-09-22 and still shows the role as open, Remote — United States, under Global Operations → Trading Operations, but the live title has changed from "Trading Operations Team Lead" to **"Trading Operations, Transformation Lead"** — same posting ID, same remote-US scope. The "Transformation Lead" framing is a positive fit signal vs. the prior title. The packet/brief/source note/preflight bank/next-step note are updated to the new title and the 2026-09-22 recheck; the public page still does not disclose compensation, so keep the packet in draft-only mode until Josh confirms the remote floor clears $120K (prefer $150K+) and the transformation-lead scope is an acceptable stretch. Anchorage's board also lists a secondary live candidate — "Member of Trading Operations" (ID `0f13c760`) — flagged as the next CI-1 candidate if this gate stays closed. Ripple is secondary hold only. | **yes** to submit/send |
