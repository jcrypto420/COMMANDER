...
| BB-24 | Bad Boys/Joycat | 2 | First sellable artifact (sticker-pack v0) | todo | draft one-page decision packet from archived brief: `Good With Teeth Pack v0`, 3-pack contents, and ranked storefront path; DROP timing still gated on cartoon-lab signal | no |
