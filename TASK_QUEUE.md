...
| CC-24 | Command Center | 1 | 5-line daily dispatch | todo | shrink Telegram morning dispatch to: 1 status line, shipped count, ≤3 lane bullets, ONE bolded decision, approval digest. Depth stays in repo/dashboard — the report must fit on a phone screen | no |
...
| CC-19 | Command Center | 1 | Midday + evening cron loops | todo | created 2026-07-02 night; verify 1pm/6pm commits land 2026-07-03, then archive | verify only |
| CC-20 | Command Center | 1 | Apply intensity rules to live SOUL.md | todo | Josh sends the quote-your-SOUL check; if absent, apply template sections and quote after | **yes** |
...
| CC-21 | Command Center | 2 | Hermes self-audit | todo | skills/cron audit + FIX: `model_usage.csv` has no entries since 06-30 (resume per-call logging) + remove vestigial `model.base_url` openrouter line | no |
