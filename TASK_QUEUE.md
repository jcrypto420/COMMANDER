...
| CC-21 | Command Center | 3 | Model-worker benchmark + cron pinning | todo | Identify one cheap available recurring worker, validate cost/quality, then explicitly pin agent crons. Do not rely on stale model names. | no |
