...
| WO-2 | Weather Oracle | 1 | Compounding capture loop | todo | Run the single local-only Pi capture proof once, then save the manifest/result note and verify the `nws_forecast` / `openmeteo_models` 200 gate. | no |
