...
|----|---------|-----|------|--------|-------------|----------|
|| CI-1 | Career/Income | 1 | Job search per `jobs/SEARCH_PLAYBOOK.md` | doing | 2026-07-25 Coinbase Institutional Business Operations packet is the next decision surface; Josh should approve apply / tweak / kill, while the old IN-1 research-services backstop stays historical | **yes** to send |
||| CC-24 | Command Center | 1 | 5-line daily dispatch | todo | 2026-07-24 23:01 UTC parser re-check passed again; next safe step is 2026-07-25 07:30 parser re-check — assert 5 lines, confirm `Open:` / `Decide:` stay on line 4, keep exactly one bolded `Decision:`, then archive if clean | verify only |
...
||| BB-26 | Bad Boys/Joycat | 1 | Hermes idea-bank + MoA critics cron | todo | 2026-07-24 weekly packet now exists at `assets/badboys/idea-bank/weekly/2026-W30.md` with 10 premises, 5 survivors, and 5 script-card drafts; next safe step is Josh's ship/kill/tweak verdict on cadence + storage path | **yes** |
