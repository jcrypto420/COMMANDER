...
| CI-1 | Career/Income | 1 | Global high-compensation cash runway | todo | Anchorage Digital Trading Operations Team Lead is the primary decision packet: the current Lever snapshot still shows 28 postings, `Trading Operations Team Lead`, `United States`, `remote`, and `compensation: null`, so keep the packet/brief/source note/preflight bank/next-step note in draft-only mode after the 2026-09-07 morning re-entry until Josh confirms the remote floor clears $120K (prefer $150K+) and the global-team-lead stretch is acceptable; Ripple is secondary hold only. | **yes** to submit/send |
