...
| CI-1 | Career/Income | 1 | Global high-compensation cash runway | todo | Ripple Treasury Manager packet / decision brief / form-prep note / source-recheck note stays the live decision surface; morning-sync refreshed 2026-08-19; official source live-rechecked again 2026-08-19; keep the non-Coinbase scan queued behind Josh’s hold/tweak/kill verdict. | **yes** to submit/send |
| WO-2 | Weather Oracle | 2 | Compounding capture loop | blocked | Draft-only cleanup note at `projects/weather-oracle-repo-cleanup-draft.md` is current; next pass is a narrow stale-line sweep in the Weather Oracle project docs and queue wording only, while keeping the packet / run sheet / result-note bundle aligned. Reopen only after the Boring Report proves paid demand or when a buyer/partner wedge makes Forecast Receipts commercially concrete. | no |
