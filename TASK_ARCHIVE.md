...
| ID | Project | Pri | Task | Status | Final note | Approval |
|----|---------|-----|------|--------|------------|----------|
...
| CC-17 | Command Center | 1 | Mission Control access plan | done | user service live on LAN port 3011; laptop/phone on home WiFi can open `http://192.168.1.189:3011` | yes |
